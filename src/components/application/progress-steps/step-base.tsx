...
export const statuses = {
    ...
    current: {
        icon: "bg-[#56B3E5] ring-2 ring-[#56B3E5] ring-offset-bg-primary ring-offset-2",
        dot: "bg-fg-white",
        connector: "border-[#56B3E5]",
        title: "text-sky-700",
    ...
    return (
        <div className={cx("flex w-full flex-col items-center justify-center gap-4", size === "sm" && "gap-3")}>
            ...
            <div className={cx("flex w-full flex-col items-start gap-0.5 self-stretch", size === "sm" && "gap-0")}>
                <p className={cx("w-full text-center", statuses[status].title, size === "sm" ? "text-xs font-semibold" : "text-md font-semibold")}>{title}</p>
                <p className={cx("w-full text-center", statuses[status].description, size === "sm" ? "text-xs" : "text-md")}>{description}</p>
            </div>
        </div>
    );
};
    ...
    return (
        <div className={cx("group flex h-max flex-row items-start justify-start gap-4", size === "sm" && "gap-3")}>
            ...
            <div className={cx("flex flex-col items-start", size === "sm" ? "pt-0.5 not-group-last:pb-6" : "pt-1 not-group-last:pb-8")}>
                <p className={cx(statuses[status].title, size === "sm" ? "text-xs font-semibold" : "text-md font-semibold")}>{title}</p>
                <p className={cx(statuses[status].description, size === "sm" ? "text-xs" : "text-md")}>{description}</p>
            </div>
        </div>
    );
};
...
export const FeaturedIconTop = <T extends ComponentType>({
    ...
    return (
        <div className={cx("flex w-full flex-col items-center justify-center gap-4", size === "sm" && "gap-3")}>
            ...
            <div className={cx("flex w-full flex-col items-start gap-0.5 self-stretch", status === "incomplete" && "opacity-60", size === "sm" && "gap-0")}>
                <p className={cx("w-full text-center text-secondary", size === "sm" ? "text-xs font-semibold" : "text-md font-semibold")}>{title}</p>
                <p className={cx("w-full text-center text-tertiary", size === "sm" ? "text-xs" : "text-md")}>{description}</p>
            </div>
        </div>
    );
};
    ...
    return (
        <div className={cx("group flex flex-row gap-4", status !== "current" && "opacity-60", size === "sm" && "gap-3")}>
            ...
            <div className={cx("flex flex-col items-start", size === "sm" ? "pt-1 not-group-last:pb-6" : "not-group-last:pb-8")}>
                <p className={cx("text-secondary", size === "sm" ? "text-xs font-semibold" : "text-md font-semibold")}>{title}</p>
                <p className={cx("text-tertiary", size === "sm" ? "text-xs" : "text-md")}>{description}</p>
            </div>
        </div>
    );
};

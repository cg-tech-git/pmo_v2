...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-[#56B3E5] text-white shadow-xs-skeumorphic ring-1 ring-[#56B3E5] ring-inset hover:bg-[#49A3D2] hover:ring-[#49A3D2] data-loading:bg-[#49A3D2] data-loading:ring-[#49A3D2]",
